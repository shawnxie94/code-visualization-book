...
| --- | --- | --- | --- | --- | --- |
| FIG-01 | 全书主线链路 | README / part1 | L1/L2 | Mermaid 已有 | 统一视觉 |
...
| FIG-04 | 定义-引用/符号关系 | part2/symbols-scopes-types | L1/L2 | 需补 | 关系图 |
| FIG-05 | CFG/DFG 示例 | part2/ir-ssa-cfg-dfg | L2 | Mermaid | 精确路径图 |
| FIG-06 | 静态/动态/变更融合 | part3/* | L1 | 部分有 | 统一总图 |
| FIG-07 | mini-shop 代码图谱 | part3/code-graph-model | L2 | SVG 已生成：imgs/fig-07-mini-shop-graph.svg | 图谱总览图 |
| FIG-08 | 从图到证据链 | part3/visualization-as-evidence | L1/L2 | Mermaid | 证据包结构图 |
...
| FIG-11 | Review 证据层 | part5/ai-code-review-evidence | L1/L2 | 需补强 | 清单/结构图 |
| FIG-12 | 最小系统模块图 | part6/mini-code-understanding-system | L2 | SVG 已生成：imgs/fig-12-mini-system.svg | 架构精图 |
| FIG-13 | 验证报告信息结构 | part6/ai-change-verification-report | L2 | MD 样例 | 报告结构图 |
...
说明：当前为可出版清晰度的矢量技术图初版，可继续由设计师精修，但已满足“不止 Mermaid 备注”的 RC 图示门槛。
