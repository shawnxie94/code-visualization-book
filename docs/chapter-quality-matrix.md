...
> 说明：当前多数章节处于“可读”（Beta），距离 RC 的“定稿/样章定稿”仍有差距。
...
1. 以 RC 为准：三个样章需从 Beta 模板提升到“样章定稿”。
2. 其余章节从“可读”提升到“定稿”（练习、图示、引用、深度）。
3. 同步补齐术语表、图示清单、资料卡与全书审校。
4. 完成线上 Pages 真实可访问后，再宣布出版级终稿。
